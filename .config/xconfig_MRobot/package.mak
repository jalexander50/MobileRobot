...
override PKGDIR = xconfig_MRobot
...
package/%.xdc.inc package/%_xconfig_MRobot.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_MRobot" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: MRobot.pem4f

-include package/cfg/MRobot_pem4f.mak
-include package/cfg/MRobot_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/MRobot_pem4f.dep
endif
MRobot.pem4f: package/cfg/MRobot_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
MRobot.pem4f package/cfg/MRobot_pem4f.c: .libraries,em4f
endif

package/cfg/MRobot_pem4f.c package/cfg/MRobot_pem4f.h package/cfg/MRobot_pem4f.xdl: override _PROG_NAME := MRobot.xem4f
package/cfg/MRobot_pem4f.c: package/cfg/MRobot_pem4f.cfg
package/cfg/MRobot_pem4f.xdc.inc: package/cfg/MRobot_pem4f.xdl
package/cfg/MRobot_pem4f.xdl package/cfg/MRobot_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/MRobot_pem4f.cfg
	-$(RM) package/cfg/MRobot_pem4f.dep
	-$(RM) package/cfg/MRobot_pem4f.c
	-$(RM) package/cfg/MRobot_pem4f.xdc.inc

clean,em4f::
	-$(RM) MRobot.pem4f
.executables,em4f .executables: MRobot.xem4f

MRobot.xem4f: |MRobot.pem4f

-include package/cfg/MRobot.xem4f.mak
MRobot.xem4f: package/cfg/MRobot_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/MRobot_pem4f.oem4f   package/cfg/MRobot_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
MRobot.xem4f: export C_DIR=
MRobot.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
MRobot.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

MRobot.test test,em4f test: MRobot.xem4f.test

MRobot.xem4f.test:: MRobot.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 MRobot.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.MRobot.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,MRobot.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
MRobot_pem4f.oem4f,copy : package/cfg/MRobot_pem4f.oem4f
MRobot_pem4f.sem4f,copy : package/cfg/MRobot_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_MRobot
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_MRobot.tar.dep
endif
package/rel/xconfig_MRobot/xconfig_MRobot/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_MRobot/xconfig_MRobot/package/package.rel.xml: package/build.cfg
package/rel/xconfig_MRobot/xconfig_MRobot/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_MRobot/xconfig_MRobot/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_MRobot.tar: package/rel/xconfig_MRobot.xdc.inc package/rel/xconfig_MRobot/xconfig_MRobot/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_MRobot.xdc.inc,package/rel/xconfig_MRobot.tar.dep)


release release,xconfig_MRobot: all xconfig_MRobot.tar
clean:: .clean
	-$(RM) xconfig_MRobot.tar
	-$(RM) package/rel/xconfig_MRobot.xdc.inc
	-$(RM) package/rel/xconfig_MRobot.tar.dep
